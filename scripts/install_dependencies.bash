...
sudo apt-get install doxygen ros-indigo-uwsim ros-indigo-underwater-dynamics #if we change ros-indigo-desktop to ros-indigo-desktop-full we can remove the uwsim bit
