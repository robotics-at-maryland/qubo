 ...
 */
class QSCUConnectionException : public std::runtime_error
{
    public:
        QSCUConnectionException(std::string message)
 ...
 */
class QSCUFunctionalException : public std::runtime_error
{
    public:
        QSCUFunctionalException(std::string message)
            : runtime_error(message) {}
};
...
#include "functions.h"
    ...
    private: // Internal functionality.
        ...
        Message sendMessage(Transaction *transaction, void *payload, void *response);
};
