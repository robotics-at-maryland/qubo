...
BuoyAction::~BuoyAction(){}



void BuoyAction::updateAction(const Mat cframe) {
...
Mat BuoyAction::backgroundSubtract(const Mat cframe){
...
bool  BuoyAction::updateHistory(const Mat cframe, vector<KeyPoint> keypoints, Point2f center){
