...
blobsNotFound = []
images = glob.glob('/home/dlinko/Documents/ball-tracking/Frame_screenshot_19.01.2017.png')
...
for fname in images:
    ...
    frame=cv2.GaussianBlur(crop_frame, (11, 11), 0)
    ...
    # define range of red/yellow color in HSV
    # colorMin = (5,55,228)
    # colorMax = (42, 170, 255)
