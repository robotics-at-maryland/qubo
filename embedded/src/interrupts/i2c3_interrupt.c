    ...
    case STATE_WRITE_NEXT:
      {
        ...
        //
        ROM_I2CMasterDataPut(I2C_DEVICE, **i2c3_buffer);
        *i2c3_buffer = (*i2c3_buffer) + 1;
        *i2c3_count = *i2c3_count - 1;
        //
    ...
    case STATE_SEND_ACK:
      {
        ...
        //
        ROM_I2CMasterSlaveAddrSet(I2C_DEVICE, *i2c3_address, true);
        //
    ...
    case STATE_READ_ONE:
      {
        ...
        //
        *i2c3_int_state = STATE_READ_WAIT;
        //
        // This state is done.
        //
        break;
    ...
    case STATE_READ_FIRST:
      {
        ...
        //
        *i2c3_int_state = STATE_READ_NEXT;
        //
        // This state is done.
        //
        break;
    ...
    case STATE_READ_NEXT:
      {
        ...
        //
        **i2c3_buffer = ROM_I2CMasterDataGet(I2C_DEVICE);
        *i2c3_buffer = (*i2c3_buffer) + 1;
        *i2c3_count = *i2c3_count - 1;
        //
