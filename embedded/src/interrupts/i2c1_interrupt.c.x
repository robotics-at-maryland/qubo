    ...
    case STATE_WRITE_NEXT:
      {
        ...
        //
        ROM_I2CMasterDataPut(I2C_DEVICE, **i2c1_buffer);
        *i2c1_buffer = (*i2c1_buffer) + 1;
        *i2c1_count = *i2c1_count - 1;
        //
    ...
    case STATE_READ_ONE:
      {
        ...
        //
        *i2c1_int_state = STATE_READ_WAIT;
        //
        // This state is done.
        //
        break;
    ...
    case STATE_READ_FIRST:
      {
        ...
        //
        *i2c1_int_state = STATE_READ_NEXT;
        //
        // This state is done.
        //
        break;
    ...
    case STATE_READ_NEXT:
      {
        ...
        //
        **i2c1_buffer = ROM_I2CMasterDataGet(I2C_DEVICE);
        *i2c1_buffer = (*i2c1_buffer) + 1;
        *i2c1_count = *i2c1_count - 1;
        //
