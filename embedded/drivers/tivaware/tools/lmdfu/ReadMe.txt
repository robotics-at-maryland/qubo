========================================================================
          TivaWare Device Firmware Upgrade Interface Library
========================================================================

This project contains a DLL offering access to the USB Device Firmware
Upgrade function available on Tiva USB-enabled microcontrollers.
The API here may be used to download new application binaries to devices
running the TivaWare USB boot loader and also to perform various
